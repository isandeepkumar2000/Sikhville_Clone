                    ...
                    <table class = "table table-bordered table-striped">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th>Video        Playback Singer By               : -</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (!empty($item->highlighting_second_video_Image))
                                                    <img src = "{{ url('skh/public/' . $item->highlighting_second_video_Image) }}"
                                                         alt = "highlighting Video Image" width = "100px" height = "100px">
                                                @else
                                            ...
                                            <td>
                                                @if (!empty($item->top_featured_video_Image_slider))
                                                    <img src = "{{ url('skh/public/' . $item->top_featured_video_Image_slider) }}"
                                            ...
                                            <td>
                                                @if (!empty($item->middle_featured_video_Image_slider))
                                                    <img src = "{{ url('skh/public/' . $item->middle_featured_video_Image_slider) }}"
                                                         alt = "Featured Video Image" width = "100px" height = "100px">
                                                @else
                                                    <p>youtube image available</p>
                                                @endif
                                            ...
                                            <td>
                                                @if (!empty($item->bottom_featured_video_Image_slider))
                                                    <img src = "{{ url('skh/public/' . $item->bottom_featured_video_Image_slider) }}"
                                                         alt = "Featured Video Image" width = "100px" height = "100px">
                                                @else
                                                    <p>youtube image available</p>
                                                @endif
                                            ...
                                            <td>
                                                <button
                                                       class       = "btn btn-sm btn-{{ $item->top_video_slider ? 'success' : 'primary' }} featured-games-btn"
                                                       data-toggle = "modal"
                                                       data-target = "#featuredModal_{{ $item->id }}">
                                                    <i class       = "fas fa-star me-1"
                                                       style       = "margin-right: 2px;"></i>{{ $item->top_video_slider ? 'Added' : 'Not Added' }}
                                                </button>
                                            </td>

                                            <td>
                                                <button
                                                       class       = "btn btn-sm btn-{{ $item->middle_video_slider ? 'success' : 'primary' }} featured-games-btn"
                                                       data-toggle = "modal"
                                                       data-target = "#featuredModal_{{ $item->id + 1 }}">
                                                    <i class       = "fas fa-star me-1"
                                                       style       = "margin-right: 2px;"></i>{{ $item->middle_video_slider ? 'Added' : 'Not Added' }}
                                                </button>
                                            </td>

                                            <td>
                                                <button
                                                       class       = "btn btn-sm btn-{{ $item->bottom_video_slider ? 'success' : 'primary' }} featured-games-btn"
                                                       data-toggle = "modal"
                                                       data-target = "#featuredModal_{{ $item->id + 2 }}">
                                                    <i class       = "fas fa-star me-1"
                                                       style       = "margin-right: 2px;"></i>{{ $item->bottom_video_slider ? 'Added' : 'Not Added' }}
                                                </button>
                                            </td>
