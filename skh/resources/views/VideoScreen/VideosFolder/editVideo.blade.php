        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center bg-info text-white">
                    <h4 class="m-0">Welcome to Video Section <i class="bi bi-camera-video-fill"></i></h4>
                    <a href="{{ url('video_list') }}" class="btn btn-danger"><i class="bi bi-arrow-left"></i> BACK</a>
                </div>
                <div class="card-body">
                    <form action="{{ url('update_video_list/' . $video->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="custom-select" id="validationCustom11" name="video_release_type">
                                    <option value="Worldwide" @if($video->video_release_type == 'Worldwide') selected
                                        @endif>Worldwide</option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="validationCustom12">Film Certificate Rating </label>
                                <select class="custom-select" id="validationCustom12" name="film_certificate_ratings">
                                    <option value="U/A" @if($video->film_certificate_ratings == 'U/A') selected
                                        @endif>U/A</option>
                                    <option value="U" @if($video->film_certificate_ratings == 'U') selected @endif>U
                                    </option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom11514543" placeholder="video_playback_singer_by" name="video_playback_singer_by" value="{{ $video->video_playback_singer_by }}">
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="validationCustom13">Video Singer </label>
                                <input type="text" class="form-control" id="validationCustom1528583" placeholder="video_singer_details" name="video_singer_details" value="{{ $video->video_singer_details }}">
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="validationCustom185853">Video Lyrics </label>
                                <input type="text" class="form-control" id="validationCustom1858583" placeholder="video_lyrics_details" name="video_lyrics_details" value="{{ $video->video_lyrics_details }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="validationCustom14">Video Quality</label>
                                <select class="custom-select" id="validationCustom14" name="video_quality_in">
                                    <option value="SD" @if($video->video_quality_in == 'SD') selected @endif>SD</option>
                                    <option value="FULL HD" @if($video->video_quality_in == 'FULL HD') selected
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="custom-select" id="validationCustom16" name="video_dimension_type">
                                    <option value="2D" @if($video->video_dimension_type == '2D') selected @endif>2D
                                    </option>
                                    <option value="3D" @if($video->video_dimension_type == '3D') selected @endif>3D
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="highlighting_second_video_Image">Upload Highlighting Second Video Image</label>
                        ...
                        <button type="submit" class="btn btn-primary"><i class="bi bi-cloud-upload"></i> Update
                        </button>
                    </form>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            <img src="{{ url('skh/public/' . $video->highlighting_second_video_Image) }}" alt="highlighting Second Video Image" width="100px" height="40px">
                            <form action="{{ route('delete_highlighting_image', $video->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger btn-sm"><i class="bi bi-x"></i> Delete Second Image</button>
                            </form>
                        </div>
                        @endif
                        ...
                        <div class="col-md-4 mb-3">
                            <img src="{{ url('skh/public/' . $video->highlighting_video_Image) }}" alt="highlighting Video Image" width="100px" height="40px">
                            <form action="{{ route('delete_highlighting_image', $video->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger btn-sm"><i class="bi bi-x"></i> Delete Video Image</button>
                            </form>
                        </div>
                        @endif
                    </div>
