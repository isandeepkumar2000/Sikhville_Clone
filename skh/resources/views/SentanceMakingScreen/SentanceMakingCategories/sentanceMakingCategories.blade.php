        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a style="margin-left: 35px" href="{{ url('add_sentance_making_categories_list') }}" class="btn btn-primary float-end">Add
                    </a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $item->name }}</td>
                                    <td>
                                        <a href="{{ url('edit_sentance_making_categories_list/' . $item->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                    </td>
                                    <td>
                    ...
                    {{ $sentancemakingCategories->links('Pagination.default') }}
