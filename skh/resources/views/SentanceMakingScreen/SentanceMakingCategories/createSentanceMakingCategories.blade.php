...
<head>
    ...
    <title>Sentance_Making_Category_Create</title>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4>Add Santance Making Category Here</h4>
                                </div>
                                <div class="card-body">

                                    <form action="{{ url('add_post_sentance_making_categories_list') }}" method="POST">
                                        @csrf

                                        <div class="form-group mb-3">
                                            <label for="">Sentance Making Category
                                                List</label>
