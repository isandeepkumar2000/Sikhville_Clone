        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>All Punjabi Reading Category </h4>

                </div>
                <div class="card-body">
                    <form action="{{ url('add_post_punjabi_reading_categories_list') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" class="form-control-file" id="thumbnail_ishort_image" name="thumbnail_ishort_image" required>
                        </div>
                        <div class="mb-3">
