        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('update_punjabi_reading_list/' . $punjabireading->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                <div class="col-md-12 mb-3">
                                    <label for="shopping_id">Select Punjab Reading</label>
                                    <select class="form-control select2" name="punjabireadingCategoriesid" required
                                        id="punjabireadingCategoriesid">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" required id="validationCustom02"
                                        value="{{ $punjabireading->thumbnail_big_image }}" placeholder="Image Url"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" required id="validationCustom03"
                                        value="{{ $punjabireading->reading_summary_pdf }}" placeholder="Short Description"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" required id="validationCustom03"
                                        value="{{ $punjabireading->reading_video_url }}" placeholder="Short Description"
